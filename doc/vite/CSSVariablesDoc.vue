<template>
    <DocSectionText v-bind="$attrs">
        <p>Next step is defining the default values for the colors in RGB format, this can be done in any CSS file in your Vite application e.g. <i>src/assets/base.css</i>.</p>
