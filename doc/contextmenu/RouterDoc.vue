<template>
    ...
    <div class="card flex justify-center">
        <span class="inline-flex items-center justify-center border-2 border-primary-500 dark:border-primary-400 rounded w-[4rem] h-[4rem]" @contextmenu="onRightClick" aria-haspopup="true">
