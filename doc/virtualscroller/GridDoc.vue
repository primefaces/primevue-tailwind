<template>
    ...
    <div class="card flex justify-center">
        <VirtualScroller :items="items" :itemSize="[50, 100]" orientation="both" class="border border-surface-300 dark:border-surface-700 rounded-md" style="width: 200px; height: 200px">
