        ...
        >
            ...
            <template #footer>
                <div class="flex items-center bg-black/90 text-white">
                    <Button icon="pi pi-list" @click="onThumbnailButtonClick" :pt="{ root: { class: 'border-0 rounded-none hover:bg-white/10', style: 'background: transparent' } }" />
                    <Button :icon="slideButtonIcon" @click="toggleAutoSlide" :pt="{ root: { class: 'border-0 rounded-none hover:bg-white/10', style: 'background: transparent' } }" />
