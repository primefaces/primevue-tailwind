<template>
    ...
    <div v-if="false" class="flex flex-wrap card items-center gap-5">
        <a href="https://github.com/primefaces/primevue-examples/tree/main/vite-quickstart" class="flex flex-col items-center">
        ...
        <a href="https://github.com/primefaces/primevue-examples/tree/main/nuxt-quickstart" class="flex flex-col items-center">
        ...
        <a href="https://github.com/primefaces/primevue-examples/tree/main/astro-quickstart" class="text-800 flex flex-col items-center">
