<template>
    ...
    <div class="card flex flex-wrap gap-4">
        <div class="flex flex-col">
            <label for="stacked-buttons" class="font-medium block mb-2 text-surface-700 dark:text-surface-300"> Stacked </label>
            <InputNumber v-model="value1" inputId="stacked-buttons" showButtons mode="currency" currency="USD" />
        </div>

        <div class="flex flex-col">
            <label for="minmax-buttons" class="font-medium block mb-2 text-surface-700 dark:text-surface-300"> Min-Max Boundaries </label>
            <InputNumber v-model="value2" inputId="minmax-buttons" mode="decimal" showButtons :min="0" :max="100" />
        </div>
        <div class="flex flex-col">
            <label for="horizontal-buttons" class="font-medium block mb-2 text-surface-700 dark:text-surface-300"> Horizontal with Step </label>
            <InputNumber
                v-model="value3"
