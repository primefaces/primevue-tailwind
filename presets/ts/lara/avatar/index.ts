import { AvatarPassThroughMethodOptions, AvatarPassThroughOptions } from "primevue/avatar";
export default {
  root: ({ props, parent }: AvatarPassThroughMethodOptions) => ({
    class: [
      // Font
      {
...
} satisfies AvatarPassThroughOptions;
