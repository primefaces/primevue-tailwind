import { TreeSelectPassThroughOptions, TreeSelectSharedPassThroughMethodOptions } from "primevue/treeselect";
...
export default {
  ...
  tree: ({ props, state }: TreeSelectSharedPassThroughMethodOptions) => {
    ...
    return {
      ...
      checkbox: ({ context }: TreePassThroughMethodOptions) => ({
        class: [
          "relative",
          ...
          {
            "hover:border-primary-500 dark:hover:border-primary-400": !treeProps.disabled,
            "ring ring-primary-400/50 dark:ring-primary-300/50": !treeProps.disabled && treeState.focused,
            "cursor-default opacity-60": treeProps.disabled,
          },
