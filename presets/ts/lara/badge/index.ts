import { BadgePassThroughOptions, BadgeProps } from "primevue/badge";

export default {
  root: ({ props }: { props: BadgeProps }) => ({
    class: [
      // Font
      "font-bold",
      ...
      // Shape
      {
        "rounded-full": props.value == 1,
        "rounded-[0.71rem]": props.value !== 1,
      },
...
} satisfies BadgePassThroughOptions;
