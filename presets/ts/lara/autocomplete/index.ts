import { AutoCompletePassThroughMethodOptions, AutoCompletePassThroughOptions } from "primevue/autocomplete";
...
export default {
  ...
  container: ({ state }: AutoCompletePassThroughMethodOptions) => ({
    class: [
      // Font
      ...
      // { "ring ring-primary-400/50 dark:ring-primary-300/50": state.hovered }, // AutoCompleteState has no hovered property
      // Transition
