import { SplitButtonPassThroughMethodOptions, SplitButtonPassThroughOptions } from "primevue/splitbutton";
  ...
  button: {
    root: ({ parent }: SplitButtonPassThroughMethodOptions) => ({
      class: [
        ...
        {
          "text-white dark:text-surface-900":
            parent.props.severity === "success" && !parent.props.text && !parent.props.outlined && !parent.props.plain,
        ...
        {
          "text-white dark:text-surface-900":
            parent.props.severity === "info" && !parent.props.text && !parent.props.outlined && !parent.props.plain,
        ...
        {
          "text-white dark:text-surface-900":
            parent.props.severity === "warning" && !parent.props.text && !parent.props.outlined && !parent.props.plain,
        ...
        {
          "text-white dark:text-surface-900":
            parent.props.severity === "help" && !parent.props.text && !parent.props.outlined && !parent.props.plain,
        ...
        {
          "text-white dark:text-surface-900":
            parent.props.severity === "danger" && !parent.props.text && !parent.props.outlined && !parent.props.plain,
        ...
        // Text & Outlined Button
        {
          "hover:bg-primary-300/20":
            (parent.props.text || parent.props.outlined) && parent.props.severity === null && !parent.props.plain,
        },
        ...
        // Text & Outlined Button
        {
          "hover:bg-green-300/20":
            (parent.props.text || parent.props.outlined) && parent.props.severity === "success" && !parent.props.plain,
        },
        ...
        // Text & Outlined Button
        {
          "hover:bg-blue-300/20":
            (parent.props.text || parent.props.outlined) && parent.props.severity === "info" && !parent.props.plain,
        },
        ...
        // Text & Outlined Button
        {
          "hover:bg-orange-300/20":
            (parent.props.text || parent.props.outlined) && parent.props.severity === "warning" && !parent.props.plain,
        },
        ...
        // Text & Outlined Button
        {
          "hover:bg-purple-300/20":
            (parent.props.text || parent.props.outlined) && parent.props.severity === "help" && !parent.props.plain,
        },
        ...
        {
          "hover:bg-red-300/20":
            (parent.props.text || parent.props.outlined) && parent.props.severity === "danger" && !parent.props.plain,
        },
