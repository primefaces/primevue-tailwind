...
export default {
  ...
  dayLabel: ({ context }) => ({
    class: [
      ...
      // Colors
      {
        "text-primary-500 dark:text-primary-400": context.today,
        "text-surface-600 dark:text-white/70 bg-transparent": !context.selected && !context.disabled && !context.today,
