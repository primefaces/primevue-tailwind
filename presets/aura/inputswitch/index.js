    ...
    slider: ({ props }) => ({
        class: [
            ...
            // Colors
            {
                ...
                'bg-primary-500 dark:bg-primary-400': props.modelValue == props.trueValue && !props.invalid,
            ...
            { 'peer-hover:bg-primary-600 dark:peer-hover:bg-surface-300': props.modelValue == props.trueValue && !props.disabled && !props.invalid },
