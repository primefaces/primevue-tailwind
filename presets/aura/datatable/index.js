    ...
    column: {
        ...
        filtermenubutton: ({ context }) => ({
            class: [
                ...
                // Color
                { 'bg-highlight text-primary-highliht-inverse': context.active },
            ...
            box: ({ props }) => ({
                class: [
                    ...
                    },
                    {
                        ...
                        'peer-hover:border-primary-emphasis': !props.disabled && props.value == props.modelValue && props.value !== undefined,
