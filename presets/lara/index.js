...
`
    ...
    fileupload: {
        ...
        chooseButton: {
            class: ['text-white bg-primary-500 border border-primary-500 p-3 px-5 rounded-md text-base', 'overflow-hidden relative']
        },
        chooseIcon: {
            ...
            class: [
                ...
                },
                {
                    'bg-surface-0 dark:bg-surface-900 border-surface-50 dark:border-surface-700 text-surface-700 dark:text-white/80 hover:bg-surface-100 dark:hover:bg-surface-800/80 hover:border-surface-50 dark:hover:bg-surface-800/70 hover:text-surface-700 dark:hover:text-white/80':
                        !props.modelValue,
                    'bg-primary-500 border-primary-500 text-white hover:bg-primary-600 hover:border-primary-600': props.modelValue
                },
                { 'opacity-60 select-none pointer-events-none cursor-default': props.disabled }
            ]
        }),
    ...
    skeleton: {
        root: ({ props }) => ({
            class: [
                ...
                '!mb-2',
                'bg-surface-300 dark:bg-surface-800',
                'after:absolute after:top-0 after:left-0 after:right-0 after:bottom-0 after:content after:w-full after:h-full after:bg-primary-400 after:left-full after:transform after:translate-x-full after:z-10 after:bg-gradient-to-r after:from-transparent after:via-white after:to-transparent animate-pulse',
                {
        ...
        column: {
            ...
            filterrowitem: ({ context }) => ({
                class: [
                    ...
                    'transition duration-200',
                    context?.highlighted ? 'text-primary-700 bg-primary-100 dark:text-white/80 dark:bg-primary-300' : 'text-surface-600 bg-transparent dark:text-white/80 dark:bg-transparent'
                ]
            }),
            filteroperator: {
                class: [
