export default {
    ...
    headercontent: {
        class: [
            'border border-solid border-surface-200 dark:border-surface-700 text-surface-700 dark:text-white/80 bg-surface-50 dark:bg-surface-900 rounded-md transition-shadow duration-200',
    ...
    menucontent: {
        class: 'py-1 border border-t-0 border-surface-200 dark:border-surface-700 bg-surface-0 dark:bg-surface-900 text-surface-700 dark:text-white/80 rounded-t-none rounded-br-md rounded-bl-md'
    },
    menu: {
