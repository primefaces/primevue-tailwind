...
`
    ...
    panel: {
        header: ({ props }) => ({
            class: [
                ...
                'border border-surface-50 bg-surface-50 text-surface-700 rounded-tl-lg rounded-tr-lg', // borders and colors
        ...
        toggler: {
            class: [
                ...
                'w-8 h-8 text-surface-600 border-0 bg-transparent rounded-full transition duration-200 ease-in-out', // widths, borders, and transitions
                'hover:text-surface-900 hover:border-transparent hover:bg-surface-100 dark:hover:text-surface-0/80 dark:hover:bg-surface-800/80', // hover
                'focus:outline-none focus:outline-offset-0 focus-visible:ring focus-visible:ring-primary-400/50 ring-inset dark:focus-visible:ring-primary-300/50 ring-inset' // focus
            ]
        },
        togglerIcon: {
            class: 'inline-block'
        ...
        content: {
            class: [
                'p-5 border border-surface-50 bg-surface-0 text-surface-700 border-t-0 last:rounded-br-lg last:rounded-bl-lg',
                'dark:bg-surface-900 dark:border-surface-700 dark:text-surface-0/80' // Dark mode
            ]
        },
        ...
        accordiontab: {
            ...
            headerAction: ({ context }) => ({
                class: [
                    ...
                    'border border-surface-50 bg-surface-50 text-surface-600', // Borders and colors
                    'dark:bg-surface-900 dark:border-surface-700 dark:text-surface-0/80 dark:hover:bg-surface-800/80', // Dark mode
                    'hover:border-surface-50 hover:bg-surface-100 hover:text-surface-900', // Hover
            ...
            content: {
                class: [
                    'p-5 border border-surface-50 bg-surface-0 text-surface-700 border-t-0 rounded-tl-none rounded-tr-none rounded-br-lg rounded-bl-lg',
                    'dark:bg-surface-900 dark:border-surface-700 dark:text-surface-0/80' // Dark mode
                ]
            },
            transition: TRANSITIONS.toggleable
    ...
    card: {
        root: {
            class: [
                'bg-surface-0 text-surface-700 shadow-md rounded-md', // Background, text color, box shadow, and border radius.
                'dark:bg-surface-900 dark:text-surface-0' //dark
            ]
        },
        body: {
            class: 'p-5'
        ...
        subtitle: {
            class: [
                'font-normal mb-2 text-surface-600', // Font weight, margin bottom, and text color.
                'dark:text-surface-0/60' //dark
            ]
        },
        content: {
    ...
    divider: {
        root: ({ props }) => ({
            class: [
                ...
                {
                    'w-full my-5 mx-0 py-0 px-5 before:block before:left-0 before:absolute before:top-1/2 before:w-full before:border-t before:border-surface-50 before:dark:border-surface-700': props.layout == 'horizontal', // Padding and borders for horizontal layout.
                    'min-h-full mx-4 md:mx-5 py-5 before:block before:min-h-full before:absolute before:left-1/2 before:top-0 before:transform before:-translate-x-1/2 before:border-l before:border-surface-50 before:dark:border-surface-700':
        ...
        content: {
            class: 'px-1 bg-surface-0 z-10 dark:bg-surface-900' // Padding and background color.
        }
    },
    fieldset: {
        root: {
            class: [
                'border border-surface-50 bg-surface-0 text-surface-700 rounded-md block mx-2 my-0.5 pl-4 pr-5 inline-size-min', // Borders, background, text color, spacing, and inline size.
                'dark:bg-surface-900 dark:border-surface-700 dark:text-surface-0/80' //dark
            ]
        },
        legend: ({ props }) => ({
            class: [
                'border border-surface-50 text-surface-700 bg-surface-50 font-bold rounded-md',
                'dark:bg-surface-900 dark:border-surface-700 dark:text-surface-0/80', //dark
                {
                    'p-0 transition-none hover:bg-surface-100 hover:border-surface-50 hover:text-surface-900 dark:hover:text-surface-0/80 dark:hover:bg-surface-800/80 focus:outline-none focus:outline-offset-0 focus:ring focus:ring-primary-400/50 ring-inset dark:focus:ring-primary-300/50':
                        props.toggleable,
        ...
        toggler: ({ props }) => ({
            class: [
                ...
                {
                    'p-5 text-surface-700 rounded-md transition-none cursor-pointer overflow-hidden relative select-none hover:text-surface-900 focus:outline-none focus:outline-offset-0 focus:ring focus:ring-primary-400/50 dark:focus:ring-primary-300/50 ring-inset':
                        props.toggleable
                }
            ]
        }),
    ...
    tabview: {
        ...
        nav: {
            class: ['flex flex-1 list-none m-0 p-0', 'bg-surface-0 border border-surface-50 border-0 border-b-2', 'dark:bg-surface-900 dark:border-surface-700 dark:text-surface-0/80 ']
        },
        tabpanel: {
            header: ({ props }) => ({
                class: [
            ...
            headerAction: ({ parent, context }) => ({
                class: [
                    ...
                    {
                        'border-surface-50 bg-surface-0 text-surface-700 hover:bg-bg-surface-0 hover:border-surface-100 hover:text-surface-900 dark:bg-surface-900 dark:border-surface-700 dark:text-surface-0/80 dark:hover:bg-surface-800/80':
    ...
    splitter: {
        root: ({ context }) => ({
            class: [
                'bg-surface-0 dark:bg-surface-900 rounded-lg text-surface-700 dark:text-surface-0/80',
                {
        ...
        gutter: ({ props }) => ({
            class: [
                ...
                'transition-all duration-200 bg-surface-50 dark:bg-surface-800',
                {
        ...
        gutterhandler: ({ props }) => ({
            class: [
                'bg-surface-100 dark:bg-surface-600 transition-all duration-200',
                {
    ...
    fileupload: {
        ...
        buttonbar: {
            class: ['flex flex-wrap', 'bg-surface-50 dark:bg-surface-800 p-5 border border-solid border-surface-50 dark:border-surface-700 text-surface-700 dark:text-white/80 rounded-tr-lg rounded-tl-lg gap-2 border-b-0']
        },
        chooseButton: {
            class: ['text-white bg-pink-500 border border-primary-500 p-3 px-5 rounded-md text-base', 'overflow-hidden relative']
        },
        chooseIcon: {
        ...
        content: {
            class: ['relative', 'bg-surface-0 dark:bg-surface-900 p-8 border border-surface-50 dark:border-surface-700 text-surface-700 dark:text-white/80 rounded-b-lg']
        },
        file: {
            class: ['flex items-center flex-wrap', 'p-4 border border-surface-50 dark:border-surface-700 rounded gap-2 mb-2', 'last:mb-0']
        },
        thumbnail: {
            class: 'shrink-0'
        },
    ...
    speeddial: {
        ...
        action: {
            class: ['flex items-center justify-center rounded-full relative overflow-hidden', 'w-12 h-12 bg-surface-700 hover:bg-surface-800 text-white']
        },
        mask: ({ state }) => ({
            class: [
        ...
        slider: ({ props }) => ({
            class: [
                ...
                "before:absolute before:content-'' before:top-1/2 before:bg-surface-0 before:dark:bg-surface-900 before:w-5 before:h-5 before:left-1 before:-mt-2.5 before:rounded-full before:transition-duration-200",
                {
                    ...
                    'bg-pink-500 before:transform before:translate-x-5': props.modelValue
                }
            ]
        })
    },
    ...
    inputmask: {
        root: {
            class: 'font-sans text-base text-surface-700 dark:text-white/80 bg-surface-0 dark:bg-surface-900 py-3 px-3 border border-surface-50 dark:border-surface-700 hover:border-primary-500 focus:outline-none focus:outline-offset-0 focus:ring focus:ring-primary-400/50 ring-inset dark:focus:ring-primary-300/50 transition duration-200 ease-in-out appearance-none rounded-md'
        }
    },
    rating: {
        root: ({ props }) => ({
    ...
    selectbutton: {
        ...
        button: ({ context }) => ({
            class: [
                ...
                'focus:outline-none focus:outline-offset-0 focus:ring focus:ring-primary-400/50 ring-inset dark:focus:ring-primary-300/50',
                {
                    'bg-surface-0 dark:bg-surface-900 text-surface-700 dark:text-white/80 border-surface-50 dark:border-surface-700 hover:bg-surface-50 dark:hover:bg-surface-800/80 ': !context.active,
                    'bg-pink-500 border-primary-500 text-white hover:bg-pink-600': context.active,
                    'opacity-60 select-none pointer-events-none cursor-default': context.disabled
                }
            ]
        }),
    ...
    slider: {
        ...
        handle: ({ props }) => ({
            class: [
                ...
                'focus:outline-none focus:outline-offset-0 focus:ring focus:ring-primary-400/50 ring-inset dark:focus:ring-primary-300/50',
                'hover:bg-pink-500 hover:border hover:border-primary-500',
                {
    ...
    togglebutton: {
        root: ({ props, context }) => ({
            class: [
                ...
                {
                    'bg-surface-0 dark:bg-surface-900 border-surface-50 dark:border-surface-700 text-surface-700 dark:text-white/80 hover:bg-surface-100 dark:hover:bg-surface-800/80 hover:border-surface-50 dark:hover:bg-surface-800/70 hover:text-surface-700 dark:hover:text-white/80':
                        !props.modelValue,
                    'bg-pink-500 border-primary-500 text-white hover:bg-pink-600 hover:border-primary-600': props.modelValue
                },
                { 'opacity-60 select-none pointer-events-none cursor-default': props.disabled }
            ]
        }),
    ...
    tristatecheckbox: {
        ...
        checkbox: ({ props }) => ({
            class: [
                ...
                {
                    'border-primary-500 bg-pink-500 text-white dark:border-primary-400 dark:bg-pink-400': props.modelValue || !props.modelValue,
        ...
        input: ({ props, context }) => ({
            class: [
                ...
                'border-2 w-6 h-6 text-surface-600 rounded-lg transition-colors duration-200',
                {
                    ...
                    'border-primary-500 bg-pink-500 dark:border-primary-400 dark:bg-pink-400': context.checked
                },
                {
                    'hover:border-primary-500 dark:hover:border-primary-400 focus:outline-none focus:outline-offset-0 focus:ring focus:ring-primary-400/50 ring-inset dark:focus:ring-primary-300/50': !props.disabled,
                    'cursor-default opacity-60': props.disabled
    ...
    radiobutton: {
        ...
        input: ({ props }) => ({
            class: [
                ...
                {
                    'border-surface-50 bg-surface-0 dark:border-surface-700 dark:bg-surface-900 dark:text-white/80': props.value !== props.modelValue,
                    'border-primary-500 bg-pink-500 dark:border-primary-400 dark:bg-pink-400': props.value == props.modelValue
                },
                {
                    'hover:border-primary-500 dark:hover:border-primary-400 focus:outline-none focus:outline-offset-0 focus:ring focus:ring-primary-400/50 ring-inset dark:focus:ring-primary-300/50': !props.disabled,
                    'cursor-default opacity-60': props.disabled
    ...
    dropdown: {
        root: ({ props }) => ({
            class: [
                ...
                'bg-surface-0 border border-surface-50 transition-colors duration-200 ease-in-out rounded-md',
        ...
        item: ({ context }) => ({
            class: [
                ...
                'm-0 p-3 border-0 transition-shadow duration-200 rounded-none',
                {
                    ...
                    'bg-pink-100 text-primary-700 dark:bg-pink-400 dark:text-white/80': context.focused && context.selected,
                    'bg-pink-50 text-primary-700 dark:bg-pink-300 dark:text-white/80': !context.focused && context.selected
                }
            ]
        }),
        itemgroup: {
    ...
    calendar: {
        ...
        panel: ({ props }) => ({
            class: [
                ...
                'min-w-[350px]',
                {
                    ...
                    'inline-block overflow-x-auto border border-surface-50 dark:border-surface-700 p-2 rounded-lg': props.inline
                }
            ]
        }),
        header: {
            class: ['flex items-center justify-between', 'p-2 text-surface-700 dark:text-white/80 bg-surface-0 dark:bg-surface-900 font-semibold m-0 border-b border-surface-50 dark:border-surface-700 rounded-t-lg']
        },
        previousbutton: {
            class: [
        ...
        daylabel: ({ context }) => ({
            class: [
                ...
                },
                {
                    ...
                    'text-primary-700 bg-pink-100 hover:bg-pink-200': context.selected && !context.disabled
                }
            ]
        }),
        monthpicker: {
        ...
        timepicker: {
            class: ['flex justify-center items-center', 'border-t-1 border-solid border-surface-50 p-2']
        },
        separatorcontainer: {
        ...
        group: {
            class: ['flex-1', 'border-l border-surface-50 pr-0.5 pl-0.5 pt-0 pb-0', 'first:pl-0 first:border-l-0']
        },
        transition: TRANSITIONS.overlay
    },
    listbox: {
        ...
        headerCheckbox: ({ context }) => ({
            class: [
                ...
                'hover:border-primary-500 focus:outline-none focus:outline-offset-0 focus:ring focus:ring-primary-400/50 dark:focus:ring-primary-300/50',
                {
                    ...
                    'border-primary-500 bg-pink-500': context?.selected
                }
            ]
        }),
        headercheckboxicon: {
    ...
    autocomplete: {
        ...
        container: {
            class: [
                ...
                'px-3 py-2 gap-2',
                'font-sans text-base text-surface-700 dark:text-white/80 bg-surface-0 dark:bg-surface-900 border border-surface-50 dark:border-surface-700  transition duration-200 ease-in-out appearance-none rounded-md',
                'hover:border-primary-500 focus:outline-none focus:outline-offset-0 focus:ring focus:ring-primary-400/50 dark:focus:ring-primary-300/50'
            ]
        },
        inputtoken: {
        ...
        input: ({ props }) => ({
            class: [
                ...
                {
                    'font-sans text-base text-surface-700 dark:text-white/80 bg-surface-0 dark:bg-surface-900 p-3 border border-surface-50 dark:border-surface-700 focus:outline-none focus:outline-offset-0 focus:ring focus:ring-primary-400/50 dark:focus:ring-primary-300/50':
                        !props.multiple,
    ...
    chips: {
        ...
        container: {
            class: [
                ...
                'w-full',
                'font-sans text-base text-surface-600 dark:text-white/70 bg-surface-0 dark:bg-surface-900 p-3 border border-surface-50 dark:border-surface-700 transition-colors duration-200 appearance-none rounded-lg',
                'hover:border-primary-500 focus:outline-none focus:outline-offset-0 focus:ring focus:ring-primary-400/50 dark:focus:ring-primary-300/50'
            ]
        },
    ...
    editor: {
        toolbar: {
            class: ['bg-surface-100 rounded-tr-md rounded-tl-md', 'border border-surface-50 box-border font-sans px-2 py-1']
        },
        formats: {
            class: ['inline-block align-middle', 'mr-4']
        },
        header: {
            class: ['text-surface-700 inline-block float-left text-base font-medium h-6 relative align-middle', 'w-28', 'border-0 text-surface-600']
        }
    },
    //MISC
    badge: {
    ...
    chip: {
        root: {
            class: ['inline-flex items-center', 'bg-surface-200 text-surface-800 rounded-[16px] px-3 dark:text-white/80 dark:bg-surface-900']
        },
        label: {
    ...
    skeleton: {
        root: ({ props }) => ({
            class: [
                ...
                '!mb-2',
                'bg-surface-300 dark:bg-surface-800',
                'after:absolute after:top-0 after:left-0 after:right-0 after:bottom-0 after:content after:w-full after:h-full after:bg-pink-400 after:left-full after:transform after:translate-x-full after:z-10 after:bg-gradient-to-r after:from-transparent after:via-white after:to-transparent animate-pulse',
                {
    ...
    tag: {
        root: ({ props }) => ({
            class: [
                ...
                'bg-pink-500 text-white text-xs font-semibold px-2 py-1 ',
                {
                    'bg-green-500 ': props.severity == 'success',
                    'bg-blue-500 ': props.severity == 'info',
                    'bg-orange-500 ': props.severity == 'warning',
    ...
    inplace: {
        display: {
            class: ['p-3 rounded-md transition duration-200 text-surface-700 dark:text-white/80', 'inline cursor-pointer', 'hover:bg-surface-100 hover:text-surface-700 dark:hover:bg-surface-800/80 dark:hover:text-white/80']
        }
    },
    scrolltop: {
        root: ({ props }) => ({
            class: [
                ...
                'ml-auto',
                {
                    '!bg-pink-500 hover:bg-pink-600 text-white rounded-md h-8 w-8': props.target == 'parent',
                    '!bg-surface-700 hover:bg-surface-800 h-12 w-12 rounded-full text-white': props.target !== 'parent'
                }
            ]
        }),
        transition: {
    ...
    terminal: {
        root: {
            class: ['border border-surface-50 p-5', 'bg-surface-900 text-white dark:border-surface-700 ', 'h-72 overflow-auto']
        },
        container: {
            class: 'flex items-center'
        },
        ...
        content: ({ context }) => ({
            class: [
                ...
                'hover:text-surface-700 dark:hover:text-white/80 hover:bg-surface-100 dark:hover:bg-surface-800/80', // Hover
                {
                    ...
                    'bg-pink-500 text-primary-700 dark:bg-pink-400 dark:text-white/80': context.focused && context.active,
                    'bg-pink-50 text-primary-700 dark:bg-pink-300 dark:text-white/80': !context.focused && context.active
                }
            ]
        }),
        action: {
    ...
    dock: {
        ...
        container: {
            class: ['flex pointer-events-auto', 'bg-surface-0/10 border-white/20 p-2 border rounded-md']
        },
        menu: ({ props }) => ({
            class: [
    ...
    menu: {
        root: {
            class: 'py-1 bg-surface-0 dark:bg-surface-900 text-surface-700 dark:text-white/80 border border-surface-50 dark:border-surface-700 rounded-md w-48'
        },
        menu: {
            class: ['m-0 p-0 list-none', 'outline-none']
        },
    ...
    menubar: {
        root: {
            class: ['p-2 bg-surface-50 dark:bg-surface-900 border border-surface-50 dark:border-surface-700 rounded-md', 'flex items-center relative']
        },
        menu: ({ props }) => ({
            class: [
        ...
        content: ({ props, context }) => ({
            class: [
                ...
                { 'rounded-md': props.root },
                {
                    ...
                    'bg-surface-300 text-surface-700 dark:text-white/80 dark:bg-surface-800/90': context.focused && !context.active,
                    'bg-pink-100 text-primary-700 dark:bg-pink-400 dark:text-white/80': context.focused && context.active,
                    'bg-pink-50 text-primary-700 dark:bg-pink-300 dark:text-white/80': !context.focused && context.active
                },
                {
                    'hover:text-surface-700 dark:hover:text-white/80 hover:bg-surface-100 dark:hover:bg-surface-800/80': !context.active,
                    'hover:bg-pink-200 dark:hover:bg-pink-500': context.active
                }
            ]
        }),
        action: ({ context }) => ({
        ...
        separator: {
            class: 'border-t border-surface-50 dark:border-surface-700 my-1'
        },
        button: {
            class: [
    ...
    megamenu: {
        root: ({ props }) => ({
            class: [
                'bg-surface-100 dark:bg-surface-900  border border-surface-50 dark:border-surface-700  rounded-md',
                'flex relative',
    ...
    steps: {
        ...
        menuitem: {
            class: ['relative flex justify-center flex-1 overflow-hidden', 'before:border-t before:border-surface-50 before:dark:border-surface-700 before:w-full before:absolute before:top-1/4 before:left-0 before:transform before:-translate-y-1/2']
        },
        action: {
        ...
        step: {
            class: ['flex items-center justify-center', 'text-surface-700 dark:text-white/80 border border-surface-50 dark:border-surface-700  bg-surface-0 dark:bg-surface-900 w-[2rem] h-[2rem] leading-2rem text-sm z-10 rounded-full']
        },
        label: {
    ...
    tabmenu: {
        ...
        menu: {
            class: ['flex m-0 p-0 list-none flex-nowrap', 'bg-surface-0 border-solid border-surface-50 border-b-2', 'outline-none no-underline text-base list-none']
        },
        menuitem: {
            class: 'mr-0'
        },
        action: ({ context, state }) => ({
            class: [
                ...
                'focus:outline-none focus:outline-offset-0 focus:ring focus:ring-primary-400/50 ring-inset dark:focus:ring-primary-300/50',
                {
                    'border-surface-50 bg-surface-0 text-surface-700 hover:bg-surface-0 hover:border-surface-50 hover:text-surface-600 dark:bg-surface-900 dark:border-surface-700 dark:text-white/80 dark:hover:bg-surface-800/80':
                        state.d_activeIndex !== context.index, // Condition-based hover styles.
                    'bg-surface-0 border-primary-500 text-primary-500 dark:bg-surface-900 dark:border-primary-300 dark:text-primary-300': state.d_activeIndex === context.index // Condition-based active styles.
                }
            ],
            style: 'top:2px'
        }),
    ...
    tieredmenu: {
        root: {
            class: ['py-1 bg-surface-0 border border-surface-50 rounded-lg w-[12.5rem]', 'dark:border-surface-700 dark:bg-surface-900']
        },
        menu: {
            class: ['outline-none', 'm-0 p-0 list-none']
        },
        ...
        content: ({ context }) => ({
            class: [
                ...
                'hover:bg-surface-100 hover:text-surface-700 dark:hover:text-white/80 dark:hover:bg-surface-800/80', //Hover
                {
                    'text-surface-700': !context.focused && !context.active,
                    'bg-surface-300 text-surface-700 dark:text-white/80 dark:bg-surface-800/90': context.focused && !context.active,
                    'bg-pink-100 text-primary-700 dark:bg-pink-400 dark:text-white/80': context.focused && context.active,
        ...
        action: ({ context }) => ({
            class: [
                ...
                {
                    'text-surface-700 dark:text-white/80 hover:text-surface-700 dark:hover:text-white/80 hover:bg-surface-100 dark:hover:bg-surface-800/80': !context.active,
                    'text-primary-600 bg-pink-100': context.active
                }
            ]
        }),
        icon: {
        ...
        separator: {
            class: 'border-t border-surface-50 my-1 dark:border-surface-700'
        },
        submenu: {
            class: ['py-1 bg-surface-0 dark:bg-surface-900 border-0 shadow-md min-w-full', 'absolute z-10', 'left-full top-0']
        },
        transition: TRANSITIONS.overlay
    },
    //MEDIA
        ...
        indicatorbutton: ({ context }) => ({
            class: [
                ...
                'focus:outline-none focus:outline-offset-0 focus:ring focus:ring-primary-400/50 dark:focus:ring-primary-300/50',
                {
                    ...
                    'bg-pink-500 hover:bg-pink-600': context.highlighted
                }
            ]
        }),
        mask: {
    ...
    carousel: {
        ...
        previousbutton: {
            class: ['flex justify-center items-center self-center overflow-hidden relative shrink-0 grow-0', 'w-8 h-8 text-surface-600 border-0 bg-transparent rounded-full transition duration-200 ease-in-out mx-2']
        },
        itemscontent: {
            class: 'overflow-hidden w-full'
        },
    ...
    tree: {
        ...
        content: ({ context, props }) => ({
            class: [
                ...
                'focus:outline-none focus:outline-offset-0 focus:ring focus:ring-primary-400/50 dark:focus:ring-primary-300/50',
                { 'bg-pink-50 text-primary-600': context.selected },
        ...
        checkbox: ({ context, props }) => ({
            class: [
                ...
                {
                    'border-surface-50 bg-surface-0 dark:border-surface-700 dark:bg-surface-900': !context.checked,
                    'border-primary-500 text-white bg-pink-500 dark:border-primary-400 dark:bg-pink-400': context.checked
                },
                {
                    'hover:border-primary-500 dark:hover:border-primary-400 focus:outline-none focus:outline-offset-0 focus:ring focus:ring-primary-400/50 ring-inset dark:focus:ring-primary-300/50': !props.disabled,
                    'cursor-default opacity-60': props.disabled
    ...
    dataview: {
        content: {
            class: [
                'bg-surface-0 text-surface-700 border-0 p-0',
                'dark:bg-surface-900 dark:text-white/80' // Dark Mode
            ]
        },
        grid: {
            class: 'flex flex-wrap ml-0 mr-0 mt-0 bg-surface-0 dark:bg-surface-900'
        },
        header: {
            class: 'bg-surface-100 dark:bg-surface-800 text-surface-800 dark:text-white/80 border-surface-100 dark:border-surface-700 border-t border-b p-4 font-bold'
        }
    },
        ...
        listbutton: ({ props }) => ({
            class: [
                ...
                props.modelValue === 'list'
                    ? 'bg-pink-500 border-primary-500 text-white dark:bg-sky-300 dark:border-sky-300 dark:text-surface-900'
    ...
    organizationchart: {
        ...
        node: {
            class: [
                'relative inline-block bg-surface-0 border border-surface-50 text-surface-600 p-5',
        ...
        linedown: {
            class: [
                'mx-auto my-0 w-px h-[20px] bg-surface-300',
                'pdark:bg-surface-900/40' //Dark Mode
            ]
        },
        lineleft: ({ context }) => ({
            class: [
                'text-center align-top py-0 px-3 rounded-none border-r border-surface-50',
        ...
        lineright: ({ context }) => ({
            class: [
                ...
                'dark:border-surface-700', //Dark Mode
                {
                    'border-t border-surface-50': context.lineTop
                }
            ]
        }),
        nodecell: {
    ...
    orderlist: {
        ...
        moveupbutton: {
            root: ({ context }) => ({
                class: [
                    ...
                    'text-white bg-pink-500 border border-primary-500 rounded-md',
        ...
        header: {
            class: [
                'bg-slate-50 text-slate-700 border border-surface-50 p-5 font-bold border-b-0 rounded-t-md',
        ...
        list: {
            class: [
                ...
                'border border-surface-50 bg-surface-0 text-surface-600 py-3 px-0 rounded-b-md outline-none',
                'dark:border-surface-700 dark:bg-surface-900 dark:text-white/80' //Dark Mode
            ]
        },
        item: ({ context }) => ({
            class: [
                ...
                'transition duration-200',
                {
                    'text-primary-700 bg-pink-500/20 dark:bg-pink-300/20': context.active && !context.focused,
                    'text-primary-700 bg-pink-500/30 dark:bg-pink-300/30': context.active && context.focused,
    ...
    paginator: {
        ...
        pagebutton: ({ context }) => ({
            class: [
                ...
                'focus:outline-none focus:outline-offset-0 focus:ring focus:ring-primary-400/50 dark:focus:ring-primary-300/50', // Focus
                {
                    'bg-pink-50 border-primary-50 text-primary-700 dark:bg-pink-300': context.active
                }
            ]
        }),
        rowperpagedropdown: {
            root: ({ props, state }) => ({
                class: [
                    ...
                    'dark:bg-surface-900 dark:border-surface-700', //DarkMode
                    {
                        ...
                        'border-surface-50': !state.focused,
            ...
            item: ({ context }) => ({
                class: [
                    ...
                    {
                        'text-primary-700 bg-pink-50 dark:text-white/80 dark:bg-pink-300': !context.focused && context.selected,
                        'bg-pink-300/40': context.focused && context.selected,
        ...
        jumptopageinput: {
            ...
            input: {
                class: [
                    'font-sans text-base text-surface-600 p-3 m-0 rounded-md apperance-none',
                    'block whitespace-nowrap overflow-hidden flex-auto w-[1%] cursor-pointer text-ellipsis border border-surface-50 pr-0',
    ...
    treetable: {
        ...
        row: ({ context }) => ({
            class: [
                ...
                context.selected ? 'bg-pink-50 text-primary-700 dark:bg-pink-300 dark:text-white/80' : 'bg-surface-0 text-surface-600 dark:bg-surface-900 dark:text-white/80',
                {
        ...
        column: {
            headercell: ({ context }) => ({
                class: [
                    ...
                    'transition duration-200',
                    context.sorted ? 'bg-pink-50 text-primary-700' : 'bg-slate-50',
            ...
            sortbadge: {
                class: [
                    'h-[1.143rem] min-w-[1.143rem] leading-[1.143rem] text-primary-700 bg-pink-50 ml-2 rounded-[50%]',
                    'dark:text-white/80 dark:bg-pink-500/40' // Dark Mode
                ]
            },
            columnresizer: {
            ...
            checkbox: ({ context }) => ({
                class: [
                    'flex items-center justify-center',
                    'border-2 w-6 h-6 text-surface-600 rounded-lg transition-colors duration-200',
                    context.checked ? 'border-primary-500 bg-pink-500 dark:border-primary-400 dark:bg-pink-400' : 'border-surface-50 bg-surface-0 dark:border-surface-700 dark:bg-surface-900',
                    {
        ...
        resizehelper: {
            class: 'absolute hidden w-px z-10 bg-pink-500 dark:bg-pink-300'
        }
    },
    datatable: {
        root: ({ props }) => ({
        ...
        header: ({ props }) => ({
            class: [
                'bg-slate-50 text-slate-700 border-surface-50 font-bold p-4',
                'dark:border-surface-700 dark:text-white/80 dark:bg-surface-900', // Dark Mode
        ...
        footer: {
            class: [
                'bg-slate-50 text-slate-700 border-t-0 border-b border-x-0 border-surface-50 font-bold p-4',
                'dark:border-surface-700 dark:text-white/80 dark:bg-surface-900' // Dark Mode
            ]
        },
        column: {
            headercell: ({ context, props }) => ({
                class: [
                    'text-left border-0 border-b border-solid border-surface-50 dark:border-surface-700 font-bold',
                    'transition duration-200',
                    context?.size === 'small' ? 'p-2' : context?.size === 'large' ? 'p-5' : 'p-4', // Size
                    context.sorted ? 'bg-pink-50 text-primary-700' : 'bg-slate-50 text-slate-700', // Sort
                    context.sorted ? 'dark:text-white/80 dark:bg-pink-300' : 'dark:text-white/80 dark:bg-surface-900', // Dark Mode
                    {
            ...
            bodycell: ({ props, context }) => ({
                class: [
                    'text-left border-0 border-b border-solid border-surface-50',
                    context?.size === 'small' ? 'p-2' : context?.size === 'large' ? 'p-5' : 'p-4', // Size
            ...
            footercell: ({ context }) => ({
                class: [
                    'text-left border-0 border-b border-solid border-surface-50 font-bold',
            ...
            sortbadge: {
                class: [
                    ...
                    'text-primary-700 bg-pink-50',
                    'dark:text-white/80 dark:bg-pink-400' // Dark Mode
                ]
            },
            columnfilter: {
            ...
            filteroperator: {
                class: [
                    'px-5 py-3 border-b border-solid border-surface-50 text-slate-700 bg-slate-50 rounded-t-md',
                    'dark:border-surface-700 dark:text-white/80 dark:bg-surface-900' // Dark Mode
                ]
            },
            ...
            filterconstraint: {
                class: 'p-5 border-b border-solid border-surface-50 dark:border-surface-700'
            },
            filteraddrule: {
                class: 'py-3 px-5'
            },
            ...
            filtermenubutton: ({ context }) => ({
                class: [
                    ...
                    {
                        'bg-pink-50 text-primary-700': context.active
                    }
                ]
            }),
        ...
        bodyrow: ({ context }) => ({
            class: [
                context.selected ? 'bg-pink-50 text-primary-700 dark:bg-pink-300' : 'bg-surface-0 text-surface-600 dark:bg-surface-900',
                context.stripedRows ? (context.index % 2 === 0 ? 'bg-surface-0 text-surface-600 dark:bg-surface-900' : 'bg-pink-100/50 text-surface-600 dark:bg-surface-900') : '',
                'transition duration-200',
                'focus:outline focus:outline-[0.15rem] focus:outline-primary-200 focus:outline-offset-[-0.15rem]', // Focus
