<template>
        ...
        <div class="flex-1 last:[&>td]:border-0 rounded-lg border border-surface w-full overflow-auto">
            ...
            >
                ...
                <Column field="title" header="Title">
                    <template #body="{ data }">
                        <div class="leading-6">{{ data.title }}</div>
                    </template>
                </Column>
                <Column field="company" header="Company Name">
                    <template #body="{ data }">
                        <div class="flex items-center gap-2">
                            ...
                            <div class="leading-6">{{ data.company.name }}</div>
                        </div>
                    </template>
                </Column>
    ...
    <Drawer
        ...
        :pt="{
            root: {
                class: '!max-w-2xl !w-full !h-screen rounded-l-2xl flex flex-col relative h-full border-0 dark:border shadow-lg bg-surface-0 dark:bg-surface-900 text-surface-700 dark:text-white/80 dark:border-surface-700 transition-transform duration-300 pointer-events-auto'
            },
            footer: {
                class: 'hidden'
            }
        ...
        <template #container="">
            <div class="flex flex-col h-screen overflow-auto">
                <div class="">
                    ...
                    <div class="flex px-6">
                        <SelectButton v-model="selectedSidebarOption" :options="sidebarOptions" />
                    </div>
                </div>
                    ...
                    <div class="h-1/3 flex flex-col p-3 rounded-xl bg-emphasis">
                        ...
                        <div class="overflow-y-auto flex-1 bg-surface-0 dark:bg-surface-900 mt-2 flex flex-col rounded-lg overflow-hidden divide-y divide-surface-200 dark:divide-surface-800">
                            <div v-for="(data, index) of callLogs" :key="index" class="flex items-center gap-3 p-2">
                                ...
                                <div class="flex-1">
                                    <div class="text-sm leading-5 font-medium">{{ data.name }}</div>
                                    <div class="mt-1 text-sm leading-5">{{ data.time }}</div>
                                </div>
                    ...
                    <div class="h-1/3 flex flex-col p-3 rounded-xl bg-emphasis">
                        ...
                        <div class="overflow-y-auto flex-1 bg-surface-0 dark:bg-surface-900 mt-2 flex flex-col rounded-lg overflow-hidden divide-y divide-surface-200 dark:divide-surface-800">
                            <div v-for="(data, index) of emailRecords" :key="index" class="flex items-center gap-3 p-2">
                                ...
                                <div class="flex-1">
                                    <div class="text-sm leading-5 font-medium line-clamp-2">
                                        {{ data.title }}
                                        <span class="">
                                            {{ data.text }}
                                        </span>
                                ...
                                <div class="w-1/6 text-sm leading-5 text-right">{{ data.time }}</div>
                            </div>
                        </div>
                    </div>
                    <div class="h-1/3 flex flex-col p-3 rounded-xl bg-emphasis">
