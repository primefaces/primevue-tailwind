...
const PrimeVue = {
    version: '^3.43.0',
    description:
        'PrimeVue is an open source UI library for Vue featuring a rich set of 80+ components, a theme designer, various theme alternatives such as Material, Bootstrap, Tailaura, premium templates and professional support. In addition, it integrates with PrimeBlock, which has 400+ ready to use UI blocks to build spectacular applications in no time.'
};
...
app.use(appState);`;
    ...
    // package.json
    dependencies['tailauracss'] = '^3.3.2';
...
export const router = createRouter({
    ...
    files['tailaura.config.js'] = {
        content: `/** @type {import('tailauracss').Config} */
export default {
darkMode: 'class',
content: [
    "./index.html",
...
const tailauraConfig = `@tailaura base;
@tailaura components;
@tailaura utilities;
