<template>
    <DocComponent title="Vue ToggleSwitch Component" header="ToggleSwitch" description="ToggleSwitch is used to select a boolean value." :componentDocs="docs" :presetDoc="presetDoc" apiLink="/toggleswitch/#api" ptLink="/toggleswitch/#pt" />
</template>
