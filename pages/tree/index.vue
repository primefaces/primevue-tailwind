<template>
    <DocComponent title="Vue Tree Component" header="Tree" description="Tree is used to display hierarchical data." :componentDocs="docs" :presetDoc="presetDoc" apiLink="/tree/#api" ptLink="/tree/#pt" />
</template>
