<template>
    <DocComponent title="Vue DataTable Component" header="DataTable" description="DataTable displays data in tabular format." :componentDocs="docs" :presetDoc="presetDoc" apiLink="/datatable/#api" ptLink="/datatable/#pt" />
</template>
