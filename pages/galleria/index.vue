<template>
    <DocComponent title="Vue Gallery Component" header="Gallery" description="Galleria is a content gallery component." :componentDocs="docs" :presetDoc="presetDoc" apiLink="/galleria/#api" ptLink="/galleria/#pt" />
</template>
