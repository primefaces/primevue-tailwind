<template>
    <DocComponent title="Vue Otp Input Component" header="InputOtp" description="Input Otp is used to enter one time passwords." :componentDocs="docs" :presetDoc="presetDoc" apiLink="/inputotp/#api" ptLink="/inputotp/#pt" />
</template>
