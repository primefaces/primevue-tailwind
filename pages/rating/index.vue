<template>
    <DocComponent title="Vue Rating Component" header="Rating" description="Rating component is a star based selection input." :componentDocs="docs" :presetDoc="presetDoc" apiLink="/rating/#api" ptLink="/rating/#pt" />
</template>
