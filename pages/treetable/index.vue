<template>
    <DocComponent title="Vue TreeTable Component" header="TreeTable" description="TreeTable is used to display hierarchical data in tabular format." :componentDocs="docs" :presetDoc="presetDoc" apiLink="/treetable/#api" ptLink="/treetable/#pt" />
</template>
