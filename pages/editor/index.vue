<template>
    <DocComponent title="Vue Editor Component" header="Editor" description="Editor is rich text editor component based on Quill." :componentDocs="docs" :presetDoc="presetDoc" apiLink="/editor/#api" ptLink="/editor/#pt" />
</template>
