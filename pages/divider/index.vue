<template>
    <DocComponent title="Vue Divider Component" header="Divider" description="Divider is used to separate contents." :componentDocs="docs" :presetDoc="presetDoc" apiLink="/divider/#api" ptLink="/divider/#pt" />
</template>
